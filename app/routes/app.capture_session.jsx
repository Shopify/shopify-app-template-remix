 ...
 */
// [START build-credit-card-payments-app.capture-session]
...
// [END build-credit-card-payments-app.capture-session]

// [START build-credit-card-payments-app.capture-session.create-params]
...
// [END build-credit-card-payments-app.capture-session.create-params]
